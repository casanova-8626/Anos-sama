...
async def serverlist(ctx):
    if ctx.author.id == 894969735207329893:  #this means this command is only for mentioned ids only.
...
@bot.command()
async def info(ctx):
    text = "My name is Anos-Sama!\n I was built by casanova#8626. At present I have limited features(find out more by typing +help)\n :)"
    await ctx.send(text)  
